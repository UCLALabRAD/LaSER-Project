...
### BEGIN NODE INFO
[info]
name = CS Serial Server without Simulation
version = 1.5.1
description = Gives access to serial devices via pyserial.
instancename = %LABRADNODE% CS Serial Server without Simulation
...
class CSSerialServerNoSim(CSPollingServer):
    """
...
__server__ = CSSerialServerNoSim()
