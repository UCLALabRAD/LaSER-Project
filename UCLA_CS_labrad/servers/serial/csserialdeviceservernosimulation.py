...
__all__ = ["SerialDeviceError", "SerialConnectionError", "CSSerialDeviceServerNoSim"]
...
# DEVICE CLASS
class CSSerialDeviceServerNoSim(LabradServer):
    """
    ...
    def _matchSerial(serNode, potMatch):
        ...
        """
        serMatch = ('serial' in potMatch.lower()) and ('without' in potMatch.lower())
