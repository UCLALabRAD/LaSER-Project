...
### BEGIN NODE INFO
[info]
name = CSScriptScanner
version = 0.9
description =
instancename = CSScriptScanner
...
from UCLA_CS_labrad.servers.script_scanner.script_signals_server import CSScriptSignalsServer
import UCLA_CS_labrad.config.scriptscanner_config as sc_config
 

#import scan_methods 
from UCLA_CS_labrad.servers.script_scanner.scheduler import scheduler
import sys
import UCLA_CS_labrad.servers.script_scanner.experiment_info as experiment_info
import UCLA_CS_labrad.servers.script_scanner.single as single
import UCLA_CS_labrad.servers.script_scanner.repeat_reload as repeat_reload
import UCLA_CS_labrad.servers.script_scanner.scan_experiment_1D as scan_experiment_1D
