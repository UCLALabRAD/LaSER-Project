...
from UCLA_CS_labrad.clients.utils import createTrunk
from UCLA_CS_labrad.clients.Widgets import QInitializePlaceholder, QClientMenuHeader
...
class GUIClient(ABC):
    ...
    def __init__(self, reactor, cxn=None, parent=None):
        ...
        core_servers = {'reg': 'Registry', 'dv': 'CS Data Vault'}
